...
// Importa aquí tu pantalla de pago si está en otra ruta, por ejemplo:
...
class _PublishOfferScreenState extends State<PublishOfferScreen> {
  ...
  void _submitData() {
    if (_formKey.currentState!.validate()) {
      // Si todos los campos son válidos, navegamos a la pasarela de pago.
      // Reemplaza '/card-payment' o la ruta según corresponda en tu app:
